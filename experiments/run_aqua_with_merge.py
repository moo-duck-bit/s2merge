...
def parse_args():
    parser = argparse.ArgumentParser(description="AQUA with Node Merge Algorithm")

    parser.add_argument('--dataset_json', type=str, default='datasets/aqua/test.jsonl',
                        help='Path to AQUA test dataset')
    parser.add_argument('--train_json', type=str, default='datasets/aqua/val.jsonl',
                        help='Path to AQUA train dataset')
...
async def main():
    ...
    train_dataset = JSONLReader.parse_file(args.train_json)
